...
The open-source trading app [Tradr](https://github.com/madmatt112/tradr) is currently in a pre-release alpha state, and received a few new features today. See the release notes below! The hosted offering at tradr.cloud is being built alongside and will be live when Tradr v1.0.0 releases. No timeline yet!
