...
- [x] 1. Create shared schema primitives in src/lib/build/content-schema-primitives.ts
...
- [x] 2. Create the two per-entry schema modules
...
- [x] 3. Create the error-message formatter src/lib/build/content-error-format.ts
...
- [x] 4. Create the authoritative YAML loader src/lib/build/content-yaml-loader.ts
...
- [x] 5. Register contributions + resources collections and the loader in velite.config.ts
...
- [x] 6. Create the two YAML data files
...
- [x] 7. Extend the eslint chokepoint rule additively (importNames + helper allowlist)
...
- [x] 8. Create the parallel chokepoint scanner src/lib/build/check-content-chokepoint.ts
...
- [x] 9. Create the content chokepoint canary fixture + wire its three exemptions
...
- [x] 10. Create the scanner self-test src/lib/build/check-content-chokepoint.test.ts
...
- [x] 11. Create a SEPARATE paired-merge gate scripts/verify-content-canary-regex-pair.mjs
...
- [x] 12. Create src/lib/contributions.ts + contributions.test.ts
...
- [x] 13. Create src/lib/resources.ts + resources.test.ts
...
- [x] 14. Add shared page styling for both pages
...
- [x] 15. Create ContributionLinkRail component
...
- [x] 16. Create ContributionCard component
...
- [x] 17. Create the /contributions route page.tsx
...
- [x] 18. Create ResourceCategorySection component
...
- [x] 19. Create the /resources route page.tsx
...
- [x] 20. Move /contributions and /resources to computed sitemap entries
...
- [x] 21. Write the author documentation docs/contributions-and-resources-authoring.md
...
- [x] 22. Create scripts/check-authoring-docs.mjs + self-test + package.json script
...
- [x] 23. Create the N=10 Lighthouse cadence guard + runs-log
...
- [x] 24. Wire the three new CI steps and update verify-ci-topology.mjs
...
- [x] 25. Refine landing-page hero-card descriptions (OPTIONAL — non-blocking)
...
- [x] 26. End-to-end build verification (green build + malformed-entry hard-fail)
