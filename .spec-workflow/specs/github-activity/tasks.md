...
- [ ] 1. Add the three `format-date.ts` exports the heatmap copy needs
...
- [ ] 2. Create the per-entry schema module
...
- [ ] 3. Write the schema rejection tests
...
- [ ] 4. Create the cross-entry invariants module
...
- [ ] 6. Register the identifier field for build-error locators
...
- [ ] 7. Extend the ESLint chokepoint rule and its allowlist — both edits, one change
...
- [ ] 8. Register the collection with an empty-list data file — one change
...
- [ ] 9. **[Human-owned]** Seed the real activity data and record the query
...
- [ ] 10. Commit the 52-week audit fixture and its Prettier exemption — one change
...
- [ ] 11. Implement the derivation helper
...
- [ ] 12. Write the derivation tests, including the two-timezone regression suite
...
- [ ] 13. Add the `.contrib-heatmap__*` CSS section
...
- [ ] 14. Build the heatmap graphic — shell, SVG grid, month labels
...
- [ ] 15. Add the legend, the `aria-label` and the text equivalent
...
- [ ] 16. Integrate the heatmap into `/contributions`
...
- [ ] 17. **[Human-owned]** Verify the four things only a rendered page can settle, and record them
...
- [ ] 18. Write the freshness detector and its self-test
...
- [ ] 20. Write and register the authoring-doc section — one change
...
- [ ] 21. Add `/contributions` to the Lighthouse URL list
...
- [ ] 22. Pin the ramp's measured inputs as a regression canary
...
- [ ] 23. Add the end-to-end coverage
...
- [ ] 24. Regenerate the `/contributions` visual baselines
...
- [ ] 25. Run Lighthouse against `/contributions` and record it
