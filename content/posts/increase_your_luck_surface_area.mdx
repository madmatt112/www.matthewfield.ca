...
![Hand-drawn index card: a chart with "how many things you do" on the vertical axis and "how many people you tell" on the horizontal, the square between them shaded and labelled "Luck Surface Area"](./_assets/increase_your_luck_surface_area/luck_surface_area_1.png)
...
![Hand-drawn index card: three seedlings landing on three surfaces of the same width, labelled "Bare", "Rocky" and "Delicious", with the sprout on the rich soil growing tallest](./_assets/increase_your_luck_surface_area/luck_surface_area_2.png)
