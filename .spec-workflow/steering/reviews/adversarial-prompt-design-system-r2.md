# Adversarial Review — steering/design-system (v2)

You are a principal product designer. Your job is to tear apart this document and find every weakness — gaps, ambiguities, contradictions, unstated assumptions, failure modes that have not been considered. Do not validate or support. Use directive framing throughout.
...
1. Read the rolling memory file at /home/mcf/repo/matthew-field.ca/.spec-workflow/steering/reviews/adversarial-memory-design-system.md (it may not exist yet — the file is created/updated by each v2+ review).
2. Read the latest prior analysis at /home/mcf/repo/matthew-field.ca/.spec-workflow/steering/reviews/adversarial-analysis-design-system.md to understand what was found most recently.
...
5. After completing your analysis, write an UPDATED memory file to /home/mcf/repo/matthew-field.ca/.spec-workflow/steering/reviews/adversarial-memory-design-system.md using this format:
...
**Primary attack surface for this phase:** Consistency, accessibility, scalability of the visual system

**Example attack angles to consider:** Tokens that contradict stated principles, missing component states, insufficient color contrast, undefined responsive/spacing scale, theming gaps, conventions that will not scale across surfaces
...
## Output
Write your analysis to: /home/mcf/repo/matthew-field.ca/.spec-workflow/steering/reviews/adversarial-analysis-design-system-r2.md
