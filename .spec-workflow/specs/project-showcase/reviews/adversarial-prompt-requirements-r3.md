# Adversarial Review — project-showcase/requirements (v3)
...
1. Read the rolling memory file at /home/mcf/repo/matthew-field.ca/.spec-workflow/specs/project-showcase/reviews/adversarial-memory-requirements.md (it may not exist yet — the file is created/updated by each v2+ review).
2. Read the latest prior analysis at /home/mcf/repo/matthew-field.ca/.spec-workflow/specs/project-showcase/reviews/adversarial-analysis-requirements-r2.md to understand what was found most recently.
...
5. After completing your analysis, write an UPDATED memory file to /home/mcf/repo/matthew-field.ca/.spec-workflow/specs/project-showcase/reviews/adversarial-memory-requirements.md using this format:
...
## Output
Write your analysis to: /home/mcf/repo/matthew-field.ca/.spec-workflow/specs/project-showcase/reviews/adversarial-analysis-requirements-r3.md
