...
Failing to do either produces an area of zero. A square with one side of length 0 has no area.
...
I have to shout out [Katrina Romulo](https://www.youtube.com/watch?v=OlBm1Tme_xs) and her New York travel video for bringing the concept to my awareness. She'd been laid off two months after the proudest project of her career, and in the meantime had developed enough travel anxiety that she was saying no to most things. To break out of her funk, she booked a week in New York - with no plan whatsoever - to see if luck would find her.
...
And then the sales engineering interview. That _was_ luck landing a hit on a small surface, but there was nothing to **catch** that luckdrop, hold it, nurture it, until it could bear fruit.
...
This is my contribution to the luck surface area idea: A third dimension of substrate. Here are three different luck surface areas, each the same size, knocked over onto their backs to show their substrates from the side view. Each can catch, hold, protect, and nurture a different amount of seeds.
::lead[Your luck surface area is only as good as its substrate. Cultivate a good one.]
...
## Short Commentary: Tradr's Luck Surface

On August 27 I [posted](https://www.linkedin.com/feed/update/urn:li:activity:7498726798827040770/) about [Tradr](https://www.tradr.cloud) on LinkedIn. I had 264 followers at the time and never a post with more than a few hundred impressions.\
The post got 141,000 impressions and reached 96,000 people. 968 of those people clicked through to my profile, and 24 followed my account. By any measure, that post was a good luck hit.

The substrate caught a good chunk of that. Anyone who clicked got the live app, a working registration page, a docs site, a public repo, and a release pipeline that shipped a fix 5 days later. The first bug report came in within a day, and got fixed because I have a tight development cycle that lets me deploy quickly with reasonable safety assurances. I spent a lot of time and effort on my development loop, delivery staging, CI/CD pipelines, visibility/monitoring, etc. to make sure I could properly manage the application stack and supporting infrastructure from day one.

The substrate dropped a lot too. Tradr has 26 new users. 96,000 people saw the post, and they ultimately converted to a Tradr account at a rate of 0.027%. Yikes. I also didn't do much to cross-pollinate this website into the Tradr visibility, and I hadn't set up the newsletter yet.

The Tradr-specific substrate was in good shape and did some work. The personal branding audience-building substrate wasn't ready, and sure enough it didn't catch anything.

## More and Smaller Bets

We can't pick which surface the luck lands on, which is why another one of my cards says _more and smaller bets_: I don't know which ideas will work until I try them! So, I'm trying to do as much as I can. The outer world will tell me which ones work (by them working), and my inner world will also give me feedback about what's working _for me_.
